...
// Function to save the report as an image
async function saveReport() {
  const reportElement = document.getElementById('report-container'); // Assuming an ID for the report section
  if (!reportElement) {
  ...
  try {
    ...
    link.href = image;
    link.download = 'report.png'; // File name
